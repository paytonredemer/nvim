require("snacks").setup({
  ...
  dashboard = {
    enabled = true,
    -- Snacks' default startup section calls lazy.stats. Keep the native
    -- dashboard sections and omit that lazy.nvim-specific footer.
    sections = {
      { section = "header" },
    ...
    preset = {
        ...
        keys = {
          ...
          { icon = "󰏗 ", key = "p", desc = "Plugins", action = ":packupdate" },
